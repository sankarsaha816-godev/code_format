...
type SupplierInfo struct {
    SupplierInfoID int        `gorm:"column:supplier_info_id;primaryKey;autoIncrement" json:"supplier_info_id"`
    SupplierName   string     `gorm:"column:supplier_name;size:150;not null" json:"supplier_name"`
